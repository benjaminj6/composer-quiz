...
var quizzes = {
	easy: [
		...
		{ //question2
			...
			info: 'John Williams (1932 - present) is currently one of film\'s most prolific composers - he has won 5 Academy Awards, 4 Golden Globe Awards, 7 British Academy Film Awards, and 22 Grammy Awards (not to mention holding the record for the most award nominations held by a living person). Over his 60 years in the film industry he has composed over 130 scores, in addition to over 40 classical compositions.',
			picture: 'images/williams.jpg',
		},

		{ //question3
			question: 'Which composer is well known for his ballets, the most famous ones being \'The Nutcracker\' and \'Swan Lake\'?',
			correct: 'Pyotr Ilych Tchaikovsky',
			choices: ['Joseph Haydn', 'Edward Elgar', 'Pyotr Ilych Tchaikovsky', 'Franz Liszt'],
			info: 'Pyotr Ilych Tchaikovsky (1840-1893) was one of the first Russian composers to be recognized internationally. His pieces are known for creating a classical sound that was also distinctly \'Russian\'. Although Tchaikovsky\'s music was well recieved by the Russian public, he suffered from depression. It is actually debated whether his death at age 53 was from cholera or self-inflicted.',
